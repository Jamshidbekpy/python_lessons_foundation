...
# ___________________________________________________________________LOOK CHEK_______________________________________________________________________
while True:
    add_sell_chek = input("Qo'shilgan yoki sotilgan mahsulotlar chekini ko'rmoqchimisiz!Unda tanlang +/-")
    if add_sell_chek == "+":
        for i in range(len(add_chek_list)):
            print(i + 1, add_chek_list[i])
        add_name_chek = input("Mahsulot nomerini kiriting!")
        ...
        print("Sahifaga to'g'ri belgini kiriting!")